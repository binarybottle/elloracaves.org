...
while($i2 < $num_rows) {
    ...
    $sql2 .= 'image_master_ID="'   .trim(mysql_real_escape_string(stripslashes($_POST[update_image_master_ID.$i2]))).'", ';
    ...
    $sql2 .= 'image_plan_x="'.trim(mysql_real_escape_string(stripslashes($_POST[update_image_plan_x.$i2]))).'", ';
    $sql2 .= 'image_plan_y="'.trim(mysql_real_escape_string(stripslashes($_POST[update_image_plan_y.$i2]))).'" ';
