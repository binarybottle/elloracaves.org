//Crosshairs - http://www.java2s.com/Code/JavaScript/Event/Mousecrosshairs.htm
...
if (!e) e = window.event;    
 if (typeof e.pageY == 'number'){
  my = e.pageY - offset_crosshairs - msy;
  mx = e.pageX - offset_crosshairs;
 }
 else{
  my = e.clientY - offset_crosshairs - msy;
  mx = e.clientX - offset_crosshairs;
 }
vert.top = scrl(0) + pix;
vert.left = mx + pix;
